...
@InputType()
class FulfillmentSpecificationCreateNestedManyWithoutSellersInput {
...
export { FulfillmentSpecificationCreateNestedManyWithoutSellersInput as FulfillmentSpecificationCreateNestedManyWithoutSellersInput };
