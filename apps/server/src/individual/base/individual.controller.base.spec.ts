...
describe("Individual", () => {
  ...
  test("GET /individuals/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/individuals"}/${nonExistingId}`)
  ...
  test("GET /individuals/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/individuals"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /individuals existing resource", async () => {
