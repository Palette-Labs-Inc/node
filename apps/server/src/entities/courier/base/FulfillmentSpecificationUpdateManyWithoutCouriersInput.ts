...
@InputType()
class FulfillmentSpecificationUpdateManyWithoutCouriersInput {
...
export { FulfillmentSpecificationUpdateManyWithoutCouriersInput as FulfillmentSpecificationUpdateManyWithoutCouriersInput };
