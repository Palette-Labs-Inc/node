...
@InputType()
class FulfillmentSpecificationCreateNestedManyWithoutCouriersInput {
...
export { FulfillmentSpecificationCreateNestedManyWithoutCouriersInput as FulfillmentSpecificationCreateNestedManyWithoutCouriersInput };
