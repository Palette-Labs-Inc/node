...
@InputType()
class PromotionCreateNestedManyWithoutSearchesInput {
...
export { PromotionCreateNestedManyWithoutSearchesInput as PromotionCreateNestedManyWithoutSearchesInput };
